    ...
    return (
        <div>
            ...
            <div class="row" >
                ...
                <h2 style={{ verticalAlign: 'inherit' }}>Confira o Calendário do Meio do mês de {mes}
                </h2>
                ...
                <a style={{fontSize:'20px', textAlign: 'center'}} href='./calendario'> Acesse o calendário completo</a>
            </div>
